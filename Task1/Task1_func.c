...
static int read_matrix(FILE *f, int ***array, int *rows, int *columns) {
    int i;
    int j;
...
static int find_needed_row(int **array, int rows, int columns) {
    int i;
    int j;
    int k;
    int candidate;
...
static int **delete_row_and_shrink(int **array, int *rows, int columns, int del_row) {
    int **new_array;
    int i;
    int j;
    int dst = 0;
...
static int write_matrix(FILE *f, int **array, int rows, int columns) {
    int i;
    int j;
